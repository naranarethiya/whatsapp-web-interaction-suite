/**
 * Bootstrap + Store injection for WA Web Bridge.
 * Waits for window.Store to be available, then calls loadUtils() and applyOverrides().
...
interval = setInterval(function () {
    if (window?.Store?.AppState === undefined) {
        ...
        if (typeof window.applyOverrides === 'function') {
...
function setWindowStore() {
    ...
    /**
     * Function to modify functions (injectToFunction)
